...
import type { Asset } from "@/types/flashfusion";
...
export function ExportManager() {
  ...
  const handleImport = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      alert(
        `Successfully imported: ${ffpack.name}\nAssets: ${ffpack.assets.length}`,
      );
    } catch (error) {
        ...
        <div className="space-y-4">
          ...
          <div className="border-t pt-4">
            ...
            <div className="p-3 bg-default-100 rounded text-sm space-y-1">
              ...
              <p>
                <strong>Includes:</strong> Assets, Brand Kits, Presets,
                Provenance Metadata
              </p>
              <p>
                <strong>Use Cases:</strong> Template sharing, Asset backup, Team
                collaboration
              </p>
            </div>
          </div>
