...
const mockPacks: Pack[] = [
  ...
  },
  {
    ...
    description:
      "Professional brand identity assets including logos and guidelines",
    authorId: "user_2",
  ...
  return (
    <div className="w-full max-w-6xl mx-auto space-y-6">
      ...
      {selectedPack && (
        ...
        >
          <div
            className="bg-background p-6 rounded-lg max-w-2xl w-full"
          ...
          >
            ...
            <div className="space-y-2 mb-4">
              <p>
                <strong>Price:</strong> ${selectedPack.price}
              </p>
              <p>
                <strong>Rating:</strong> ⭐ {selectedPack.rating}
              </p>
              <p>
                <strong>Downloads:</strong> {selectedPack.downloads}
              </p>
              <p>
                <strong>Assets:</strong> {selectedPack.assets.length}
              </p>
              <div>
                <strong>Tags:</strong>
                <div className="flex flex-wrap gap-1 mt-1">
                  {selectedPack.tags.map((tag) => (
                    <span
                      key={tag}
                      className="text-xs px-2 py-1 bg-default-100 rounded"
                    >
                      {tag}
                    </span>
                  ))}
            ...
            <div className="flex gap-2">
              ...
              <Button color="default" onClick={() => setSelectedPack(null)}>
                Close
              </Button>
            </div>
          </div>
