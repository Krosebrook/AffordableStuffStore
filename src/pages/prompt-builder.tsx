    ...
    <DefaultLayout>
      <section className="flex flex-col items-center justify-center gap-4 py-8 md:py-10">
        <div className="inline-block max-w-4xl text-center justify-center">
          <h1 className={title()}>Modular Prompt Builder</h1>
          <p className="mt-4 text-default-600 text-lg">
            Build powerful AI prompts with 30+ presets, live token estimation,
        ...
        <div className="w-full max-w-6xl mt-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 p-6 rounded-lg bg-default-100">
              ...
              <p className="text-default-600">
                • 30+ presets for different content types
                <br />
          ...
          <div className="mt-6 p-6 rounded-lg bg-default-100">
            ...
            <p className="text-default-600">
              The Modular Prompt Builder is currently under development. Check
