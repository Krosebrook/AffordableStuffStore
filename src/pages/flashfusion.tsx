        ...
        <div className="w-full max-w-6xl mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="p-6 bg-default-50 rounded-lg">
            ...
            <p className="text-sm text-default-600">
              Every asset includes model, provider, prompt hash, and dataset
          ...
          <div className="p-6 bg-default-50 rounded-lg">
            ...
            <p className="text-sm text-default-600">
              Background job processing with automatic retry logic ensures
              reliable asset generation.
            </p>
          </div>
          ...
          <div className="p-6 bg-default-50 rounded-lg">
            ...
            <p className="text-sm text-default-600">
              Row-level security with org_id scoping ensures your assets are
          ...
          <div className="p-6 bg-default-50 rounded-lg">
            ...
            <p className="text-sm text-default-600">
              Automated linting and validation ensures brand consistency across
              all your assets.
            </p>
          </div>
          ...
          <div className="p-6 bg-default-50 rounded-lg">
            ...
            <p className="text-sm text-default-600">
              Export and share your templates, brand kits, and presets as
              portable .ffpack.json files.
            </p>
          </div>
          ...
          <div className="p-6 bg-default-50 rounded-lg">
            ...
            <p className="text-sm text-default-600">
              Assets are stored securely in Supabase buckets with automatic
